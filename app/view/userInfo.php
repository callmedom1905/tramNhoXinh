                    ...
                    <div class="user-info">
                        ...
                        <form id="user-info-form">
                            <div class="form-group">
                                ...
                                <input type="text" id="name" name="name" value="Nguyễn Văn A" disabled>
                            </div>

                            <div class="form-group">
                                <label for="dob">Ngày Sinh:</label>
                                <input type="date" id="dob" name="dob" value="1995-05-20" disabled>
                            </div>
                            ...
                            <button type="button" id="update-btn" class="ubtn">Cập nhật thông tin</button>
                            <button type="button" id="save-btn" class="ubtn" style="display:none;">Lưu</button>
                        </form>
                    </div>
                </div>
            </div>
