...
<head>
    ...
    <title>Bài viết sản phẩm - Túi Handmade</title>
    ...
    <main>
        <section>
            ...
            <div class="productPost">
                ...
                <!-- Tiêu đề sản phẩm -->
                <h1 class="productPost-title">Túi Handmade Shoulder Len</h1>
        ...
        <div class="l-3">
            <div class="related-posts">
                ...
                <ul>
                    <li><a href="#">Túi Handmade Shoulder Len: Lựa chọn phong cách cho bạn</a></li>
                    <li><a href="#">Cách phối đồ với túi handmade cho mùa thu</a></li>
                    <li><a href="#">Lịch sử và ý nghĩa của túi handmade từ sợi tự nhiên</a></li>
                    <li><a href="#">Hướng dẫn bảo quản túi handmade luôn như mới</a></li>
