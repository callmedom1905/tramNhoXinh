...
<head>
    ...
    <title>Bài viết sản phẩm - Móc Khóa Gỗ Vải Handmade</title>
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0-beta3/css/all.min.css">
    <link rel="stylesheet" href="../css/grid.css">
    <link rel="stylesheet" href="../css/postPro.css">
</head>
<body>
    <main>
        <section>
                ...
                <div class="productPost">
                    ...
                    <div class="l-9">
                        <div class="productPost">
                            <div class="productPost-img">
                                <img src="public/image/img_product/<?=$image?>" alt="Móc Khóa Gỗ Vải Handmade">
                            </div>
                    
                            <!-- Tiêu đề sản phẩm -->
                            <h1 class="productPost-title">Móc Khóa Gỗ Vải Handmade</h1>
                    
                            <!-- Thông tin sản phẩm -->
                            <ul class="productPost-details">
                    ...
                    <div class="l-3">
                        <div class="related-posts">
                            ...
                            <ul>
                                <li><a href="#">Xu hướng phụ kiện handmade năm 2024</a></li>
                                <li><a href="#">Cách bảo quản phụ kiện handmade để luôn như mới</a></li>
                                <li><a href="#">5 mẹo phối đồ với móc khóa gỗ vải</a></li>
                                <li><a href="#">Tại sao bạn nên chọn phụ kiện thân thiện với môi trường?</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
